...
<label
	class="relative inline-flex items-center gap-2.5 text-[13.5px] {disabled
...
>
	...
	<input
		type="checkbox"
		class="peer absolute size-[17px] cursor-[inherit] opacity-0"
		{checked}
		{disabled}
	...
	/>
	<span
		class="grid size-[17px] shrink-0 place-items-center rounded-md border-[1.5px] transition-colors peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-accent {checked
